...
assign inst_cache = hit ? (ysyx_24120011_ICACHE_SIZE == 32'd4 ? (icache[index][31+offset*32 -: 32]) : (icache[index][31+offset[$clog2(ysyx_24120011_ICACHE_SIZE)-1:2]*32 -: 32])) : 32'b0;
//====================icache====================//
