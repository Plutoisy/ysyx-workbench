...
assign IFU_valid = (rvalid  && rready ) ? 1'b1 : 1'b0;
//====================IFU====================//
...
assign inst_cache = hit ? icache[index][30 -: 32 - $clog2(ysyx_24120011_ICACHE_SIZE) - $clog2(ysyx_24120011_ICACHE_NUM)][31+offset*32:0+offset*32] : 32'b0;
//====================icache====================//
