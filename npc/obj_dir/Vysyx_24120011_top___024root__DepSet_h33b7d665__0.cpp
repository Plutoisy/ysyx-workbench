...
void Vysyx_24120011_top___024root___eval_triggers__ico(Vysyx_24120011_top___024root* vlSelf) {
    ...
    vlSelf->__VicoTriggered.at(1U) = (vlSelf->ysyx_24120011_top__DOT__wdata 
                                      != vlSelf->__Vtrigrprev__TOP__ysyx_24120011_top__DOT__wdata);
    vlSelf->__Vtrigrprev__TOP__ysyx_24120011_top__DOT__wdata 
        = vlSelf->ysyx_24120011_top__DOT__wdata;
...
void Vysyx_24120011_top___024unit____Vdpiimwrap_rtl_pmem_read_TOP____024unit(IData/*31:0*/ raddr, IData/*31:0*/ &rtl_pmem_read__Vfuncrtn);

VL_INLINE_OPT void Vysyx_24120011_top___024root___ico_comb__TOP__0(Vysyx_24120011_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_24120011_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_24120011_top___024root___ico_comb__TOP__0\n"); );
    // Body
    if (vlSelf->ysyx_24120011_top__DOT__w_mem_en) {
        Vysyx_24120011_top___024unit____Vdpiimwrap_rtl_pmem_write_TOP____024unit(vlSelf->ysyx_24120011_top__DOT__alu_result, vlSelf->ysyx_24120011_top__DOT__wdata, 
                                                                                ((3U 
    ...
    if (vlSelf->ysyx_24120011_top__DOT__r_mem_en) {
            ...
            vlSelf->ysyx_24120011_top__DOT__rdata = 
                ((IData)(vlSelf->ysyx_24120011_top__DOT__sign_extension)
                  ? (((- (IData)((1U & (vlSelf->ysyx_24120011_top__DOT__i_MemProcessor__DOT__rdata_tmp 
                                        >> 7U)))) << 8U) 
                     | (0xffU & vlSelf->ysyx_24120011_top__DOT__i_MemProcessor__DOT__rdata_tmp))
                  : (0xffU & vlSelf->ysyx_24120011_top__DOT__i_MemProcessor__DOT__rdata_tmp));
        }
        ...
        if ((4U == (IData)(vlSelf->ysyx_24120011_top__DOT__r_mem_len))) {
            vlSelf->ysyx_24120011_top__DOT__rdata = vlSelf->ysyx_24120011_top__DOT__i_MemProcessor__DOT__rdata_tmp;
        }
    } else {
        vlSelf->ysyx_24120011_top__DOT__i_MemProcessor__DOT__rdata_tmp = 0U;
        vlSelf->ysyx_24120011_top__DOT__rdata = 0U;
    }
    vlSelf->ysyx_24120011_top__DOT__wdata = ((8U & (IData)(vlSelf->ysyx_24120011_top__DOT__rd_ctrl))
                                              ? 0U : 
...
void Vysyx_24120011_top___024root___eval_triggers__act(Vysyx_24120011_top___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.at(0U) = (vlSelf->ysyx_24120011_top__DOT__wdata 
                                      != vlSelf->__Vtrigrprev__TOP__ysyx_24120011_top__DOT__wdata);
