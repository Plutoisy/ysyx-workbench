...
class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull_AsyncQueueSink_UInt32 final : public VerilatedModule {
  public:
    ...
    CData/*3:0*/ __VdfgRegularize_h865e5b43_1_0;
    CData/*0:0*/ __VdfgRegularize_h865e5b43_1_1;
