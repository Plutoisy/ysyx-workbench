...
void Vysyx_24120011_top___024root__trace_chg_sub_0(Vysyx_24120011_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+42,(((0U == (IData)(vlSelf->ysyx_24120011_top__DOT__pc_ctrl))
                              ? ((IData)(4U) + vlSelf->pc)
    ...
    bufp->chgCData(oldp+43,((0x1fU & (vlSelf->inst 
                                      >> 0xfU))),5);
    bufp->chgCData(oldp+44,((0x1fU & (vlSelf->inst 
                                      >> 0x14U))),5);
    bufp->chgCData(oldp+45,((0x1fU & (vlSelf->inst 
                                      >> 7U))),5);
    bufp->chgCData(oldp+46,((7U & (vlSelf->inst >> 0xcU))),3);
    bufp->chgCData(oldp+47,((vlSelf->inst >> 0x19U)),7);
    bufp->chgIData(oldp+48,(((4U & (IData)(vlSelf->ysyx_24120011_top__DOT__rd_ctrl))
                              ? 0U : ((2U & (IData)(vlSelf->ysyx_24120011_top__DOT__rd_ctrl))
                                       ...
                                       : ((1U & (IData)(vlSelf->ysyx_24120011_top__DOT__rd_ctrl))
                                           ...
                                           : ((IData)(4U) 
                                              + vlSelf->pc))))),32);
    bufp->chgIData(oldp+49,(vlSelf->ysyx_24120011_top__DOT__i_RegStack__DOT__Regs
                            [(0x1fU & (vlSelf->inst 
                                       >> 0xfU))]),32);
    bufp->chgIData(oldp+50,(vlSelf->ysyx_24120011_top__DOT__i_RegStack__DOT__Regs
                            [(0x1fU & (vlSelf->inst 
                                       >> 0x14U))]),32);
    bufp->chgIData(oldp+51,(vlSelf->ysyx_24120011_top__DOT__pc_add_imme_out),32);
    bufp->chgIData(oldp+52,(((IData)(4U) + vlSelf->pc)),32);
    bufp->chgIData(oldp+53,(((1U & ((0U != (IData)(vlSelf->ysyx_24120011_top__DOT__i_IDU__DOT__opcode_type)) 
                                    | (~ (IData)(vlSelf->ysyx_24120011_top__DOT__i_IDU__DOT____VdfgExtracted_h236fc9a3__0))))
                              ? vlSelf->ysyx_24120011_top__DOT__i_RegStack__DOT__Regs
                             [(0x1fU & (vlSelf->inst 
                                        >> 0x14U))]
                              : vlSelf->ysyx_24120011_top__DOT__imme)),32);
    bufp->chgIData(oldp+54,(vlSelf->ysyx_24120011_top__DOT__alu_result),32);
    bufp->chgCData(oldp+55,((0x7fU & vlSelf->inst)),7);
}
