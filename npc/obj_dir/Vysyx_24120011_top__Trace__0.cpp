...
void Vysyx_24120011_top___024root__trace_chg_sub_0(Vysyx_24120011_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+10,(vlSelf->ysyx_24120011_top__DOT__r_mem_data),32);
        ...
        bufp->chgIData(oldp+13,(((IData)(vlSelf->ysyx_24120011_top__DOT__ALUBctrl)
        ...
        bufp->chgIData(oldp+15,(vlSelf->ysyx_24120011_top__DOT__i_MemProcessor__DOT__r_mem_data_tmp),32);
    }
    ...
    bufp->chgIData(oldp+85,(((0U == (IData)(vlSelf->ysyx_24120011_top__DOT__pc_ctrl))
                              ? ((IData)(4U) + vlSelf->pc)
    ...
    bufp->chgIData(oldp+91,(((8U & (IData)(vlSelf->ysyx_24120011_top__DOT__rd_ctrl))
