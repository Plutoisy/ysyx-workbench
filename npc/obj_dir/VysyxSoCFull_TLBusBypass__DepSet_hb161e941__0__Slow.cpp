...
VL_ATTR_COLD void VysyxSoCFull_TLBusBypass___ctor_var_reset(VysyxSoCFull_TLBusBypass* vlSelf) {
    ...
    vlSelf->__PVT__bar__DOT__nodeIn_a_ready = VL_RAND_RESET_I(1);
    vlSelf->__PVT__bar__DOT__nodeIn_d_valid = VL_RAND_RESET_I(1);
    vlSelf->__PVT__bar__DOT__nodeIn_d_bits_opcode = VL_RAND_RESET_I(3);
    vlSelf->__PVT__bar__DOT__nodeIn_d_bits_param = VL_RAND_RESET_I(2);
    vlSelf->__PVT__bar__DOT__nodeIn_d_bits_size = VL_RAND_RESET_I(3);
    vlSelf->__PVT__bar__DOT__nodeIn_d_bits_source = VL_RAND_RESET_I(4);
    vlSelf->__PVT__bar__DOT__nodeIn_d_bits_sink = VL_RAND_RESET_I(5);
    vlSelf->__PVT__bar__DOT__nodeIn_d_bits_denied = VL_RAND_RESET_I(1);
    vlSelf->__PVT__bar__DOT__nodeIn_d_bits_corrupt = VL_RAND_RESET_I(1);
    ...
    vlSelf->error__DOT____VdfgRegularize_hed1f7a03_0_3 = VL_RAND_RESET_I(1);
