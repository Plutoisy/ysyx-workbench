...
class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull_TX final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT___txInc_sink_io_deq_valid;
        CData/*0:0*/ __PVT___rxInc_sink_io_deq_valid;
