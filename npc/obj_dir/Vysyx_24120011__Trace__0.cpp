...
void Vysyx_24120011___024root__trace_chg_0_sub_0(Vysyx_24120011___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgBit(oldp+52,(vlSelfRef.ysyx_24120011__DOT__M1_arready));
                                  ...
                                  ? ((1U & (- (IData)(
                                     ...
                                     | (2U & (- (IData)(
                                                        (4U 
                                                         == (IData)(vlSelfRef.ysyx_24120011__DOT__r_mem_len))))))
                                  : 2U)),3);
        bufp->chgIData(oldp+54,(vlSelfRef.ysyx_24120011__DOT__M1_rdata),32);
        bufp->chgBit(oldp+55,(vlSelfRef.ysyx_24120011__DOT__M1_rvalid));
        ...
        bufp->chgBit(oldp+59,(vlSelfRef.ysyx_24120011__DOT__M1_awready));
        ...
        bufp->chgBit(oldp+64,(vlSelfRef.ysyx_24120011__DOT__M1_wready));
