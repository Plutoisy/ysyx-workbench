...
VL_ATTR_COLD void VysyxSoCFull_TLToAXI4___ctor_var_reset(VysyxSoCFull_TLToAXI4* vlSelf) {
    ...
    vlSelf->__PVT___queue_arw_deq_q_io_deq_bits_id = VL_RAND_RESET_I(5);
    vlSelf->__PVT___queue_arw_deq_q_io_deq_bits_addr = VL_RAND_RESET_I(32);
    vlSelf->__PVT___queue_arw_deq_q_io_deq_bits_len = VL_RAND_RESET_I(8);
    vlSelf->__PVT___queue_arw_deq_q_io_deq_bits_size = VL_RAND_RESET_I(3);
    vlSelf->__PVT___queue_arw_deq_q_io_deq_bits_burst = VL_RAND_RESET_I(2);
    vlSelf->__PVT___queue_arw_deq_q_io_deq_bits_echo_tl_state_size = VL_RAND_RESET_I(4);
    vlSelf->__PVT___queue_arw_deq_q_io_deq_bits_echo_tl_state_source = VL_RAND_RESET_I(7);
    ...
    vlSelf->__PVT__nodeIn_a_ready = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__nodeOut_rready = VL_RAND_RESET_I(1);
    vlSelf->__PVT__nodeOut_bready = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__nodeIn_d_bits_size = VL_RAND_RESET_I(3);
    vlSelf->__PVT__nodeIn_d_bits_source = VL_RAND_RESET_I(7);
    vlSelf->__PVT__nodeIn_d_bits_denied = VL_RAND_RESET_I(1);
    vlSelf->__PVT__nodeIn_d_bits_corrupt = VL_RAND_RESET_I(1);
    ...
    vlSelf->__VdfgRegularize_h4906b29d_1_1 = VL_RAND_RESET_I(5);
    vlSelf->__VdfgRegularize_h4906b29d_1_2 = VL_RAND_RESET_I(1);
    ...
    vlSelf->__PVT__nodeOut_wdeq_q__DOT__io_deq_valid_0 = VL_RAND_RESET_I(1);
