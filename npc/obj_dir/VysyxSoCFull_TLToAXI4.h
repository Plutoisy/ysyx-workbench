...
class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull_TLToAXI4 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*4:0*/ __PVT___queue_arw_deq_q_io_deq_bits_id;
        CData/*7:0*/ __PVT___queue_arw_deq_q_io_deq_bits_len;
        CData/*2:0*/ __PVT___queue_arw_deq_q_io_deq_bits_size;
        CData/*1:0*/ __PVT___queue_arw_deq_q_io_deq_bits_burst;
        CData/*3:0*/ __PVT___queue_arw_deq_q_io_deq_bits_echo_tl_state_size;
        CData/*6:0*/ __PVT___queue_arw_deq_q_io_deq_bits_echo_tl_state_source;
        ...
        CData/*0:0*/ __PVT__nodeIn_a_ready;
        CData/*0:0*/ __PVT__out_arw_valid;
        CData/*0:0*/ __PVT__r_holds_d;
        CData/*2:0*/ __PVT__b_delay;
        CData/*0:0*/ __PVT__r_wins;
        CData/*0:0*/ __PVT__nodeOut_rready;
        CData/*0:0*/ __PVT__nodeOut_bready;
        CData/*0:0*/ __PVT__nodeIn_d_valid;
        CData/*0:0*/ __PVT__r_first;
        CData/*0:0*/ __PVT__r_denied_r;
        CData/*0:0*/ __PVT__r_denied;
        CData/*2:0*/ __PVT__nodeIn_d_bits_size;
        CData/*6:0*/ __PVT__nodeIn_d_bits_source;
        CData/*0:0*/ __PVT__nodeIn_d_bits_denied;
        CData/*0:0*/ __PVT__nodeIn_d_bits_corrupt;
        ...
        CData/*4:0*/ __VdfgRegularize_h4906b29d_1_1;
        CData/*0:0*/ __VdfgRegularize_h4906b29d_1_2;
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__nodeOut_wdeq_q__DOT__io_deq_valid_0;
        ...
        IData/*31:0*/ __PVT___queue_arw_deq_q_io_deq_bits_addr;
