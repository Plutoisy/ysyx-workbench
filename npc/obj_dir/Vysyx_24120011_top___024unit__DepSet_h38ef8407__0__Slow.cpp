...
VL_ATTR_COLD void Vysyx_24120011_top___024unit___ctor_var_reset(Vysyx_24120011_top___024unit* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_24120011_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_24120011_top___024unit___ctor_var_reset\n"); );
}
