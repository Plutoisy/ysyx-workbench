...
class alignas(VL_CACHE_LINE_BYTES) VysyxSoCFull_TLBusBypass final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ __PVT__bar__DOT__nodeIn_a_ready;
        CData/*0:0*/ __PVT__bar__DOT__nodeIn_d_valid;
        CData/*2:0*/ __PVT__bar__DOT__nodeIn_d_bits_opcode;
        CData/*1:0*/ __PVT__bar__DOT__nodeIn_d_bits_param;
        CData/*2:0*/ __PVT__bar__DOT__nodeIn_d_bits_size;
        CData/*3:0*/ __PVT__bar__DOT__nodeIn_d_bits_source;
        CData/*4:0*/ __PVT__bar__DOT__nodeIn_d_bits_sink;
        CData/*0:0*/ __PVT__bar__DOT__nodeIn_d_bits_denied;
        CData/*0:0*/ __PVT__bar__DOT__nodeIn_d_bits_corrupt;
    ...
    struct {
        ...
        CData/*0:0*/ error__DOT____VdfgRegularize_hed1f7a03_0_3;
