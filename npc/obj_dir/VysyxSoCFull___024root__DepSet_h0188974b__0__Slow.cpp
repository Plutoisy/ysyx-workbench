...
VL_ATTR_COLD void VysyxSoCFull___024root___eval_initial__TOP(VysyxSoCFull___024root* vlSelf) {
    ...
    // Body
    VL_READMEM_N(true, 24, 4194304, 0, VL_CVT_PACK_STR_NW(17, VysyxSoCFull__ConstPool__CONST_h037ca5da_0)
...
VL_ATTR_COLD void VysyxSoCFull___024root___ctor_var_reset(VysyxSoCFull___024root* vlSelf) {
    ...
    vlSelf->ysyxSoCFull__DOT__asic__DOT__lvga__DOT__mvga__DOT__my_vga_ctrl__DOT__x_cnt = VL_RAND_RESET_I(12);
