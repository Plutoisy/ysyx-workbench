...
VL_INLINE_OPT void Vysyx_24120011___024unit____Vdpiimwrap_reg_out_TOP____024unit(VlUnpacked<IData/*31:0*/, 32> array) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_24120011___024unit____Vdpiimwrap_reg_out_TOP____024unit\n"); );
    // Body
    int array__Vcvt[32];
...
VL_INLINE_OPT void Vysyx_24120011___024unit____Vdpiimwrap_IFU_clktime_count_TOP____024unit(IData/*31:0*/ ifu_clk_count, IData/*31:0*/ hit) {
...
VL_INLINE_OPT void Vysyx_24120011___024unit____Vdpiimwrap_icahce_miss_count_TOP____024unit(IData/*31:0*/ miss_count) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_24120011___024unit____Vdpiimwrap_icahce_miss_count_TOP____024unit\n"); );
    // Body
...
VL_INLINE_OPT void Vysyx_24120011___024unit____Vdpiimwrap_rtl_pmem_write_TOP____024unit(IData/*31:0*/ w_mem_addr, IData/*31:0*/ w_mem_data, CData/*7:0*/ w_mem_len) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_24120011___024unit____Vdpiimwrap_rtl_pmem_write_TOP____024unit\n"); );
    // Body
...
VL_INLINE_OPT void Vysyx_24120011___024unit____Vdpiimwrap_rtl_pmem_read_TOP____024unit(IData/*31:0*/ r_mem_addr, IData/*31:0*/ &rtl_pmem_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_24120011___024unit____Vdpiimwrap_rtl_pmem_read_TOP____024unit\n"); );
    // Body
...
VL_INLINE_OPT void Vysyx_24120011___024unit____Vdpiimwrap_ebreak_TOP____024unit() {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_24120011___024unit____Vdpiimwrap_ebreak_TOP____024unit\n"); );
    // Body
    ebreak();
}
...
VL_INLINE_OPT void Vysyx_24120011___024unit____Vdpiimwrap_npc_trap_TOP____024unit(IData/*31:0*/ pc, IData/*31:0*/ ret) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_24120011___024unit____Vdpiimwrap_npc_trap_TOP____024unit\n"); );
    // Body
    int pc__Vcvt;
...
VL_INLINE_OPT void Vysyx_24120011___024unit____Vdpiimwrap_get_pc_inst_TOP____024unit(IData/*31:0*/ pc, IData/*31:0*/ dnpc, IData/*31:0*/ inst, IData/*31:0*/ IFU_valid_int) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_24120011___024unit____Vdpiimwrap_get_pc_inst_TOP____024unit\n"); );
    // Body
    int pc__Vcvt;
    for (size_t pc__Vidx = 0; pc__Vidx < 1; ++pc__Vidx) pc__Vcvt = pc;
    int dnpc__Vcvt;
...
VL_INLINE_OPT void Vysyx_24120011___024unit____Vdpiimwrap_Performance_Counters_TOP____024unit(IData/*31:0*/ Performancetype) {
    VL_DEBUG_IF(VL_DBG_MSGF("+        Vysyx_24120011___024unit____Vdpiimwrap_Performance_Counters_TOP____024unit\n"); );
    // Body
