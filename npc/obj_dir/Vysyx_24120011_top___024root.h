...
class Vysyx_24120011_top___024root final : public VerilatedModule {
  public:
    ...
    struct {
        VL_IN8(clk,0,0);
        VL_IN8(rst,0,0);
        CData/*4:0*/ ysyx_24120011_top__DOT__rd;
        CData/*2:0*/ ysyx_24120011_top__DOT__func3;
        CData/*6:0*/ ysyx_24120011_top__DOT__func7;
        ...
        CData/*6:0*/ ysyx_24120011_top__DOT__u_ysyx_24120011_IDU__DOT__opcode;
