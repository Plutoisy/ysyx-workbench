...
Vysyx_24120011::Vysyx_24120011(VerilatedContext* _vcontextp__, const char* _vcname__)
    : VerilatedModel{*_vcontextp__}
    , vlSymsp{new Vysyx_24120011__Syms(contextp(), _vcname__, this)}
...
Vysyx_24120011::Vysyx_24120011(const char* _vcname__)
    : Vysyx_24120011(Verilated::threadContextp(), _vcname__)
{
}
...
#endif  // VL_DEBUG
void Vysyx_24120011___024root___eval_static(Vysyx_24120011___024root* vlSelf);
void Vysyx_24120011___024root___eval_initial(Vysyx_24120011___024root* vlSelf);
void Vysyx_24120011___024root___eval_settle(Vysyx_24120011___024root* vlSelf);
void Vysyx_24120011___024root___eval(Vysyx_24120011___024root* vlSelf);

void Vysyx_24120011::eval_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+++++TOP Evaluate Vysyx_24120011::eval_step\n"); );
#ifdef VL_DEBUG
    // Debug assertions
    Vysyx_24120011___024root___eval_debug_assertions(&(vlSymsp->TOP));
#endif  // VL_DEBUG
    ...
    if (VL_UNLIKELY(!vlSymsp->__Vm_didInit)) {
        ...
        Vysyx_24120011___024root___eval_static(&(vlSymsp->TOP));
        Vysyx_24120011___024root___eval_initial(&(vlSymsp->TOP));
        Vysyx_24120011___024root___eval_settle(&(vlSymsp->TOP));
    }
    VL_DEBUG_IF(VL_DBG_MSGF("+ Eval\n"););
    Vysyx_24120011___024root___eval(&(vlSymsp->TOP));
    // Evaluate cleanup
...
//============================================================
// Events and timing
bool Vysyx_24120011::eventsPending() { return false; }

uint64_t Vysyx_24120011::nextTimeSlot() {
...
const char* Vysyx_24120011::name() const {
    return vlSymsp->name();
}
...
void Vysyx_24120011___024root___eval_final(Vysyx_24120011___024root* vlSelf);

VL_ATTR_COLD void Vysyx_24120011::final() {
    Vysyx_24120011___024root___eval_final(&(vlSymsp->TOP));
}

//============================================================
// Implementations of abstract methods from VerilatedModel

const char* Vysyx_24120011::hierName() const { return vlSymsp->name(); }
const char* Vysyx_24120011::modelName() const { return "Vysyx_24120011"; }
unsigned Vysyx_24120011::threads() const { return 1; }
void Vysyx_24120011::prepareClone() const { contextp()->prepareClone(); }
void Vysyx_24120011::atClone() const {
    contextp()->threadPoolpOnClone();
}
std::unique_ptr<VerilatedTraceConfig> Vysyx_24120011::traceConfig() const {
...
void Vysyx_24120011___024root__trace_decl_types(VerilatedVcd* tracep);

void Vysyx_24120011___024root__trace_init_top(Vysyx_24120011___024root* vlSelf, VerilatedVcd* tracep);
...
VL_ATTR_COLD static void trace_init(void* voidSelf, VerilatedVcd* tracep, uint32_t code) {
    ...
    Vysyx_24120011___024root__trace_decl_types(tracep);
    Vysyx_24120011___024root__trace_init_top(vlSelf, tracep);
    tracep->popPrefix();
}

VL_ATTR_COLD void Vysyx_24120011___024root__trace_register(Vysyx_24120011___024root* vlSelf, VerilatedVcd* tracep);

VL_ATTR_COLD void Vysyx_24120011::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    (void)levels; (void)options;
    VerilatedVcdC* const stfp = dynamic_cast<VerilatedVcdC*>(tfp);
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vysyx_24120011::trace()' called on non-VerilatedVcdC object;"
            " use --trace-fst with VerilatedFst object, and --trace-vcd with VerilatedVcd object");
    }
    stfp->spTrace()->addModel(this);
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP));
    Vysyx_24120011___024root__trace_register(&(vlSymsp->TOP), stfp->spTrace());
}
