...
VL_INLINE_OPT void VysyxSoCFull_AXI4UserYanker_1___nba_sequent__TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__axi4yank_1__0(VysyxSoCFull_AXI4UserYanker_1* vlSelf) {
    ...
    if (VL_UNLIKELY(((1U & ((~ (IData)(vlSymsp->TOP.reset)) 
        ...
        VL_WRITEF_NX("[%0t] %%Error: ysyxSoCFull.v:18072: Assertion failed in %NysyxSoCFull.asic.chipMaster.axi4yank_1.unnamedblk1: Assertion failed at UserYanker.scala:69\n\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        Verilated::runFlushCallbacks();
        VL_STOP_MT("/home/plutoisy/ysyx-workbench/ysyxSoC/build/ysyxSoCFull.v", 18072, "");
        VL_WRITEF_NX("[%0t] %%Fatal: ysyxSoCFull.v:18074: Assertion failed in %NysyxSoCFull.asic.chipMaster.axi4yank_1.unnamedblk1\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        Verilated::runFlushCallbacks();
    ...
    if (VL_UNLIKELY(((1U & ((~ (IData)(vlSymsp->TOP.reset)) 
        ...
        VL_WRITEF_NX("[%0t] %%Error: ysyxSoCFull.v:18078: Assertion failed in %NysyxSoCFull.asic.chipMaster.axi4yank_1.unnamedblk1: Assertion failed at UserYanker.scala:98\n\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        Verilated::runFlushCallbacks();
        VL_STOP_MT("/home/plutoisy/ysyx-workbench/ysyxSoC/build/ysyxSoCFull.v", 18078, "");
        VL_WRITEF_NX("[%0t] %%Fatal: ysyxSoCFull.v:18080: Assertion failed in %NysyxSoCFull.asic.chipMaster.axi4yank_1.unnamedblk1\n",0,
                     64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
        Verilated::runFlushCallbacks();
    ...
    vlSelfRef.__PVT__Queue1_BundleMap_9__DOT__unnamedblk1__DOT__do_enq 
        = (((~ (IData)(vlSelfRef.__PVT__Queue1_BundleMap_9__DOT__full)) 
           ...
           (((IData)(1U) << (0xfU & (IData)(vlSymsp->TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__tl2axi4.__PVT___queue_arw_deq_q_io_deq_bits_id))) 
            >> 7U));
    ...
    if (vlSymsp->TOP.reset) {
        ...
        vlSelfRef.__PVT__Queue17_BundleMap_1__DOT__unnamedblk1__DOT__do_deq 
            = ((((IData)(vlSelfRef.__PVT___GEN_3) & (IData)(vlSymsp->TOP.ysyxSoCFull__DOT__asic__DOT___cpu_slave_rlast)) 
                & (~ (IData)(vlSelfRef.__PVT__Queue17_BundleMap_1__DOT__empty))) 
               & (((IData)(1U) << (IData)(vlSymsp->TOP.ysyxSoCFull__DOT__asic__DOT___cpu_slave_rid)) 
                  >> 1U));
...
VL_INLINE_OPT void VysyxSoCFull_AXI4UserYanker_1___nba_sequent__TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__axi4yank_1__1(VysyxSoCFull_AXI4UserYanker_1* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT___GEN_3 = ((IData)(vlSymsp->TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__tl2axi4.__PVT__nodeOut_rready) 
                               & (IData)(vlSymsp->TOP.ysyxSoCFull__DOT__asic__DOT___cpu_slave_rvalid));
    vlSelfRef.__PVT___GEN_11 = ((IData)(vlSymsp->TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__tl2axi4.__PVT__nodeOut_bready) 
                                & (IData)(vlSymsp->TOP.ysyxSoCFull__DOT__asic__DOT___cpu_slave_bvalid));
}
...
VL_INLINE_OPT void VysyxSoCFull_AXI4UserYanker_1___nba_comb__TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__axi4yank_1__0(VysyxSoCFull_AXI4UserYanker_1* vlSelf) {
    ...
    vlSelfRef.Queue17_BundleMap_1__DOT____Vcellinp__ram_ext__W0_data 
        = (((IData)(vlSymsp->TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__tl2axi4.__PVT___queue_arw_deq_q_io_deq_bits_echo_tl_state_size) 
            << 8U) | (((IData)(vlSymsp->TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__tl2axi4.__PVT___queue_arw_deq_q_io_deq_bits_echo_tl_state_source) 
                       << 1U) | (1U & ((IData)(vlSymsp->TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__tl2axi4.__PVT___queue_arw_deq_q_io_deq_bits_id) 
                                       >> 4U))));
    vlSelfRef.__PVT___GEN_12 = (((IData)(vlSymsp->TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__tl2axi4.__PVT___queue_arw_deq_q_io_deq_bits_wen) 
    ...
    vlSelfRef.__PVT___GEN_4 = (((~ (IData)(vlSymsp->TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__tl2axi4.__PVT___queue_arw_deq_q_io_deq_bits_wen)) 
                                & (IData)(vlSymsp->TOP__ysyxSoCFull__DOT__asic__DOT__chipMaster__DOT__tl2axi4.__PVT__queue_arw_deq_q__DOT__io_deq_valid_0)) 
