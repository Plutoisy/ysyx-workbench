module ysyx_24120011_data_hazard_detection ( 
    ...
    assign o_rd_data = (hazard_exu&&i_EXU_rd_data_type==2'd2) ? i_EXU_rd_data : 32'b0;
    assign o_bypass  = (hazard_exu&&i_EXU_rd_data_type==2'd2) ? 1'b1 : 1'b0;
    assign o_rs1_or_rs2 = (i_IDU_rs1 == i_EXU_rd) ? 1'b0 : 1'b1;
